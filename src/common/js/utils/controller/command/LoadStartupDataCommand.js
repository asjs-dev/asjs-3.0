...
require("../../dataUtils/Language.js");
require("../../dataUtils/Config.js");
require("../service/LoadJSONServiceCommand.js");

helpers.createClass(ASJSUtils, "LoadStartupDataCommand", ASJS.AbstractCommand, function(_scope, _super) {
  var _dfd;
